...
#region  //内部变量
    ...
    private LauguageMgr()
    {
        ...
        LauguageType cur = LauguageType.NULL;//(LauguageType) GameModel.GetInstance().SettingsData.Language;
        Debug.LogError("cur lauguage == "+cur);
        data = new LauguageData(lauguageConfigFilePath,cur);
    }
